...
class Account:
    ...
    def deposit(self, deposit):
        if deposit < 1:
            ...
            self.deposit_arr.append(deposit)
    ...
    def withdraw(self, withdraw):
        if withdraw > self.balance:
            ...
            self.withdraw_arr.append(withdraw)
    ...
    def deposit_history(self):
        for log in self.deposit_arr:
            print(log)

    def withdraw_history(self):
        for log in self.withdraw_arr:
            print(log)
...
b = Account("C언어", 1500000)
c = Account("Java", "93,000")
arr1 = [a, b, c]
